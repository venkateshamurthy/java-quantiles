...
public class DescriptiveStatisticsTest {
    ...
    protected DescriptiveStatistics createDescriptiveStatistics(
        ...
        return new DescriptiveStatistics(copy);
    }
    ...
    public void testCopy() {
        ...
        stats.addValue(1);
        stats.addValue(3);
        DescriptiveStatistics copy =createDescriptiveStatistics(stats);
	...
	public void testWithFunctions() {
		...
		final DescriptiveStatisticalSummary<UnivariateStatistic> ds = createDescriptiveStatistics();
		final DescriptiveStatisticalSummary<UnivariateStatistic> dsMean = createDescriptiveStatistics()
				.withMean(new Mean());
		final DescriptiveStatisticalSummary<UnivariateStatistic> dsKurt = createDescriptiveStatistics()
				.withKurtosis(new Kurtosis());
		final DescriptiveStatisticalSummary<UnivariateStatistic> dsSkew = createDescriptiveStatistics()
				.withSkewness(new Skewness());
		final DescriptiveStatisticalSummary<UnivariateStatistic> ds50 = createDescriptiveStatistics()
				.withPercentile(new Percentile());
		final DescriptiveStatisticalSummary<UnivariateStatistic> dsVar = createDescriptiveStatistics()
