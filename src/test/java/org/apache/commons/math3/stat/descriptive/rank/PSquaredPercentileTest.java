...
import org.apache.commons.math3.stat.descriptive.rank.PSquaredPercentile.PSquareMarkers;
...
StorelessUnivariateStatisticAbstractTest {
    ...
    public void testNullListInMarkers() {
        ...
        // verified
        // new Markers(null, 0, PSquaredPercentile.newEstimator());
        PSquaredPercentile.newMarkers(null, 0);
    ...
    public void testHashCodeInMarkers() {
        ...
        PSquaredPercentile p2 = new PSquaredPercentile();
        Set<PSquaredPercentile> s = new HashSet<PSquaredPercentile>();
        s.add(p);
        s.add(p2);
    ...
    public void testInitial() {
        PSquaredPercentile.newMarkers(new ArrayList<Double>(), 0.5);
        Assert.fail();
    }
