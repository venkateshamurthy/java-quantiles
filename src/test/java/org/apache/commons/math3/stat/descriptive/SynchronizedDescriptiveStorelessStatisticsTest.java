...
/**
 * Test cases for the {@link SynchronizedDescriptiveStorelessStatisticsTest} class.
 *
 */
public class SynchronizedDescriptiveStorelessStatisticsTest {

    protected DescriptiveStatisticalSummary<StorelessUnivariateStatistic> 
    	createDescriptiveStatistics() {
        	return new SynchronizedDescriptiveStorelessStatistics();
    }
    ...
    public void testToString() {
        ...
        Assert.assertEquals("SynchronizedDescriptiveStorelessStatistics:\n" +
                     "n: 3\n" +
                     "min: 1.0\n" +
                     "max: 3.0\n" +
                     "mean: 2.0\n" +
